...
-- Proiezioni di test (ID 1 è quello usato nei test)
INSERT INTO screenings (movie_id, start_time, total_seats, available_seats, price, created_at) VALUES
-- Avatar proiezioni (le prime hanno ID 1, 2, 3...)
(1, DATEADD('HOUR', 2, CURRENT_TIMESTAMP), 100, 100, 12.50, CURRENT_TIMESTAMP),
(1, DATEADD('HOUR', 5, CURRENT_TIMESTAMP), 100, 95, 12.50, CURRENT_TIMESTAMP),
(1, DATEADD('DAY', 1, CURRENT_TIMESTAMP), 100, 100, 12.50, CURRENT_TIMESTAMP),

-- Top Gun proiezioni
(2, DATEADD('HOUR', 3, CURRENT_TIMESTAMP), 80, 80, 11.00, CURRENT_TIMESTAMP),
(2, DATEADD('HOUR', 6, CURRENT_TIMESTAMP), 80, 75, 11.00, CURRENT_TIMESTAMP),
(2, DATEADD('DAY', 1, CURRENT_TIMESTAMP), 80, 80, 11.00, CURRENT_TIMESTAMP),

-- The Batman proiezioni
(3, DATEADD('HOUR', 4, CURRENT_TIMESTAMP), 120, 120, 13.00, CURRENT_TIMESTAMP),
(3, DATEADD('DAY', 1, CURRENT_TIMESTAMP), 120, 120, 13.00, CURRENT_TIMESTAMP),

-- Dune proiezioni
(4, DATEADD('HOUR', 1, CURRENT_TIMESTAMP), 90, 90, 11.50, CURRENT_TIMESTAMP),
(4, DATEADD('HOUR', 7, CURRENT_TIMESTAMP), 90, 85, 11.50, CURRENT_TIMESTAMP),

-- Spider-Man proiezioni
(5, DATEADD('HOUR', 3, CURRENT_TIMESTAMP), 150, 150, 14.00, CURRENT_TIMESTAMP),
(5, DATEADD('HOUR', 8, CURRENT_TIMESTAMP), 150, 140, 14.00, CURRENT_TIMESTAMP);